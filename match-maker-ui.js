...
import { addCreditsFromPoints, getCredits } from './credits.js';
...
function cacheDom() {
  ...
  dom.credits    = document.getElementById('match-credits');
...
function updateHUD() {
  ...
  if (dom.credits) dom.credits.textContent = getCredits();
}

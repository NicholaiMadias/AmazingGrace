/**
 * diagnostics.js — Diagnostics Console module.
 *
 * Browser & DNS diagnostics for the Sovereign Matrix Diagnostics Console.
 *
 * Exports:
 *   runBrowserDiagnostics()  → Record<string, string|boolean|number>
 *   runDnsTests()            → Promise<Array<DnsResult>>
 */
...
const DNS_TARGETS = [
  ...
  { host: 'dns.google',               label: 'Google DNS (hostname)' },
];
